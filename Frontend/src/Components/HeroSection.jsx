...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="w-[95%] mt-5 h-fit bg-gradient-to-r from-blue-500 via-yellow-500 to-red-500 rounded-xl py-4 px-7 flex flex-col items-center gap-4 shadow-xl">
